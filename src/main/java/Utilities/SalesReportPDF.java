...
public class SalesReportPDF {

    private final List<SaleBill> saleBills;

    public SalesReportPDF(List<SaleBill> saleBills) {
    ...
    public static void generateReport(String rutaArchivo, List<SaleBill> saleBills) throws Exception {
    ...
    public static List<SaleBill> leerVentasDesdeExcel(String rutaArchivo) throws Exception {
        List<SaleBill> saleBills;
        try (Workbook workbook = new XSSFWorkbook(rutaArchivo)) {
